...
5) Count of failure to pay after extension in the last 6 months. These customer's are at least engaging, there is a very good opportunity to assign the best collector to control the outcome of these accounts using different negotiation tactics. (If extention is granted in the last 6 months and is currently overdue after the extention end date).
