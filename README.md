...
There is an opportunity to build out a scale to map how the increase of interest rate in the last 2 years has affected incoming payments, especially in new property estates and properties recently sold. During the point of sales, it would be wise to ascertain if the customer is a tenant or a landlord for the property requiring supply. Readily available data on websites such as on Realestate.com.au could be used to complement this model. Ultimately, the final output should be distilled down to a simple statement such as, "for every 25 basis points increase, we tend to see an average decrease of $X million in payments within our portfolio. In the new property estates where most of the sales settled in the last 5 years, we can expect more pain from these customers due to a combination of peak purchasing value and upcoming loan renewal at higher rates". 
